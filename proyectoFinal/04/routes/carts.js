...
cartsRouter.post("/:id/productos/:id_producto", validMongoId, Controllers.postProductInCart);
cartsRouter.post("/", Controllers.postCart);
cartsRouter.delete("/:id/productos/:id_producto", validMongoId, Controllers.deleteProductInCart);
